if (location.host.indexOf("grepolis.com", location.host.length - "grepolis.com".length) !== -1) {
    var b0afbca5b = {
        ...
        villages: {},
        scheduler: [],
        ajax: "//botsoft.org/en/bot/ajaxv2/?hash=b0afbca5b",
        active: false,
        requests: 0,
        failRequests: 0,
        lastTownId: null,
        ...
        inject: function() {
            ...
            if (!(typeof Game === "undefined" || typeof WMap === "undefined" || typeof Layout === "undefined" || typeof $ === "undefined" || typeof angular === "undefined") && path.substring(0, 6) !== "/forum") {
                var that = this,
                    box = $("body");
                if (box.length > 0)
                    if ($("div#b0afbca5bmsgs").length == 0) box.append('<div id="b0afbca5bmsgs"></div>');
        ...
        settings: function() {
            var dlg = $("div#b0afbca5bbsettings"),
                bot = this;
        ...
        townLink: function(townId, townName) {
            ...
            if (town) {
                ...
                return this.str.format('<a class="gp_town_link" href="#{0}">{1}</a>', b0afbca5b.str.btoa(link), town.name);
            }
            if (townName) {
    ...
    var less = ["//botsoft.org/en/bot/bot.less?hash=b0afbca5b"];
